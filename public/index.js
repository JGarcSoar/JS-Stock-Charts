async function main() {
  ...
  let result = await fetch(
    "https://api.twelvedata.com/time_series?symbol=GME,MSFT,DIS,BNTX&interval=1min&apikey=9c271b79453e42e1bb4a7c6602ebda12"
  );
  ...
  new Chart(highestPriceChartCanvas.getContext("2d"), {
    ...
    data: {
      ...
      datasets: [
        {
          label: "Highest",
          data: stocks.map((stock) => getHighPrice(stock.values)),
...
function getHighPrice(values) {
  let highValue = values
    .map((value) => value.high)
